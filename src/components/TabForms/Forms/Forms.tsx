import { Form as FormikForm, Formik, FormikHelpers, FieldArray, Field } from "formik";
import { formsValidationSchema } from "../../../utils/validationSchema";
import { Form } from "./Forms.types";

import "./Forms.css";
import { Alert, Button, FormControl, IconButton, Radio } from "@mui/material";
import { CloseOutlined } from "@mui/icons-material";
import CustomField from "../../CustomField/CustomField";

const FormsForm = ({ onSubmit }: { onSubmit: (values: Form) => void }) => {
    const onFormsSubmit = (values: Form, { resetForm }: FormikHelpers<Form>) => {
        const formattedValues: Form = {
            ...
            items: values.items.map((item) => ({
                ...
                validate: {
                    ...item.validate,
                    required: item.validate?.required === "true", // Преобразование в boolean
                },
            })),
        };
